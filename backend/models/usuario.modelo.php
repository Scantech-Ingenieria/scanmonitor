...
Class ModeloUsuarios {
	...
	static public function mdlCrearUsuarios($tabla, $datos, $rutaImagen) {
		...
		$sql = Conexion::conectar()->prepare("INSERT INTO $tabla() VALUES (NULL, :nombre, :correo, :pass, :imagen,  NOW())");
	...
	static public function mdlActualizarUsuarios($tabla, $datos, $rutaImagen) {
		...
		if( is_null($rutaImagen)) {
			$sql = Conexion::conectar()->prepare("UPDATE $tabla SET nombre_admin = :nombre, correo_admin = :correo,password_admin = :pass_usuarios, fecha = NOW() WHERE id_admin = :id");
			...
			$sql = Conexion::conectar()->prepare("UPDATE $tabla SET nombre_admin = :nombre, correo_admin = :correo,password_admin = :pass_usuarios, avatar_admin = :rutaNueva, fecha = NOW() WHERE id_admin = :id");
