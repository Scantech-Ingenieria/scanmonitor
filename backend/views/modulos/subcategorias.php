          ...
          foreach ($subcategorias as $key => $value) {
            echo '
              <tr>
                ...
                <td width="100">
                <td width="100">
                  <button class="btn btn-sm btn-info btnEditarCategorias" idsubCategorias="'.$value["id"].'" data-toggle="modal" data-target="#modal-editar-subcategorias">
                    <i class="far fa-edit"></i>
                  </button>
                  <button class="btn btn-sm btn-danger btnEliminarCategorias" idsubCategorias="'.$value["id"].'" rutaImagen="'.$value["imagen"].'">
